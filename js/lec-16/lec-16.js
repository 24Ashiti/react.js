// Document Object Model in Javascript DOM
...

{
    ...
    console.log(Model);
    document.getElementsByClassName('box').innerHTML = "hello ashiti"
    const element = document.getElementsByTagName('h1');
        function addText() {
            for (let i = 0; i < element.length; i++) {
                element[i].innerHTML = "Hello ashiti"
...

{
    ...
    // NewElement.classList = "ashiti"
    NewElement.classList.add("ashiti");
