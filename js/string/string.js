...
// let a = "hello ashiti"; // double quote
// let b = 'hello ashiti'; // single quote
// console.log(a);
...
// let ashiti ='dhanani ashiti ratilal';
// console.log(ashiti.length);
...
The replace() method is case sensitive.*/
 ...
 let text1 = "hello ashiti";
 let text2 = text1.replace("hello","dhanani");
 let text3 = text1.replace('ashiti','dhanani');
 console.log(text3);
...
let St = "heyy i am ashiti dhanani"
console.log(St);
