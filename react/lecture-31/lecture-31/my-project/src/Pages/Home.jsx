                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-4 py-4 text-right text-sm font-medium">
                        <Link to="/edit"
                          className="text-gray-700 border-2 border-black bg-slate-100 px-[20px] py-[8px] rounded-3xl me-[10px]"
                        >
                          Edit
                        </Link>
                        <a
                          href="#"
                          className="text-gray-700 border-2 border-black bg-slate-100 px-[20px] py-[8px] rounded-3xl"
                        >
                          Delete
                        </a>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-4 py-4 text-right text-sm font-medium">
                         <NavLink className="text-gray-700  border-2 border-black bg-slate-100 px-[20px] py-[8px] rounded-3xl me-[10px]" to='edit'> Edit</NavLink>
                        <Link
                          href="#"
                          className="text-gray-700  border-2 border-black bg-slate-100 px-[20px] py-[8px] rounded-3xl"
                        >
