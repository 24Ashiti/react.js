  ...
  return (
    <div>
      {localSignUp ? (
        ...
        <div className="flex h-screen bg-pink-400 justify-center items-center">
          <div className="bg-pink-300 p-12 border-4 border-solid border-white">
              ...
              {({ isSubmitting }) => (
                <Form>
                  ...
                  <button
                    ...
                    className="bg-pink-500 w-full mt-4 py-2 hover:text-white font-bold hover:border-2 hover:border-solid hover:border-white"
                  >
                    Sign Up
                  </button>
                </Form>
            ...
            <p className="mt-4 text-center cursor-pointer text-blue-500" onClick={() => setShowLogin(true)}>Already have an account? Sign In</p>
          </div>
        </div>
      )}
    </div>
